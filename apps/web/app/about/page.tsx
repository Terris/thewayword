...
export default function AboutPage() {
  return (
    <div className="w-full p-8 pt-16 text-lg">
      <div className="flex flex-col items-center md:flex-row md:gap-16 md:px-16 pb-16">
      ...
      <div className="w-full p-8 pt-16 max-w-[740px] mx-auto text-lg">
        ...
        <Text className="text-lg pb-4">
          ...
          over and I&rsquo;m back to my busy life I find myself wishing I could
          do more with the artifacts of my journey than just dropping them into
          an endless feed of memes and advertisements. The Wayword is a social
          adventure journal that makes it easy to develop and publish the
          stories of our travels. On the platform, we create adventure logs with
          maps, pictures, and text and can share these logs with friends. My
          hope is that, as a Wayword user, I can both inspire and be inspired to
          spend more time outdoors and that the ephemera of these journeys
          become a more valuable memory.&rdquo;
        </Text>
        ...
        <ol className="list-decimal pb-16 space-y-4 pl-4">
          ...
          <li>
            ...
            ensuring that future generations can continue to revel in the
